...
export function AdminDashboardPage() {
  ...
  return (
    <AdminShell>
      <h1 className="mb-5 text-3xl font-black text-ink dark:text-white">Admin dashboard</h1>
...
export function AdminCatalogPage() {
  ...
  return (
    <AdminShell>
      <div className="mb-5 flex flex-wrap items-center justify-between gap-3"><h1 className="text-3xl font-black text-ink dark:text-white">Catalog</h1><Button icon={<Plus className="size-4" />} onClick={() => addToast({ tone: "info", message: "Medicine modal opened" })}>Add medicine</Button></div>
...
export function AdminUsersPage() {
  ...
  return (
    <AdminShell>
      <h1 className="mb-5 text-3xl font-black text-ink dark:text-white">Users</h1>
...
export function AdminScrapersPage() {
  ...
  return (
    <AdminShell>
      <div className="mb-5 flex flex-wrap items-center justify-between gap-3"><h1 className="text-3xl font-black text-ink dark:text-white">Scraper config</h1><Button icon={<Plus className="size-4" />}>Add platform</Button></div>
